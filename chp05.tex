...
After user sign in to the system, the first screen that they will see is the campaign overview screen, in where all the created campaigns including the ones that are shared with the user (as a assistant) are shown as in figure \ref{fig:CampaignsOverviewScreen}. It has simple and clean \ac{UI}, deferring from regular email clients to emphasize its focus on mass email communication.

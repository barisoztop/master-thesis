...
\begin{compactitem}
	...
	\item Go over the "auto-respond" cases to figure out if they are related to a failed delivery due to the problematic email addresses or if they are just automated vacation responder, so we can setup a reminder email later on.

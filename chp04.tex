...
\section{Prototype}
\label{sec:4.2:Prot}
A software prototype provides developers a better understanding of the requirements, what could be developed with existing technology, and by allowing client interaction, it demonstrates them what is functionally feasible, and revise their imagination accordingly, which results better inputs from them, and more forward looking system \citep{Bernstein1996}. 

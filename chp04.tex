...
Such a view also help researchers to let them pick a template to reuse according to the email of the respondents. Therefore, they can easily see the previous answers that they gave, and the level of the tree provides the overall conversation state.
\begin{figure}[htbp]
	\dirtree{%
	.1 Invitation Email.
...
--> visualizaation of the status , visualization of conversation state

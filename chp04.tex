...
\paragraph{Identification of Campaign Messages}
An email message consists header and body sections as defined by RFC 5322. While a message's header keeps structured information such as "From", "To", "\ac{CC}", Subject, Date, and other information with a special syntax, a message's body can consists the content, which is unstructured text and optional to have \citep{rfc5322}. A sample email message with its header fields can be found in Appendix \ref{app:EmaiMessForm}.
...
\paragraph{Template and Email Message Relation}

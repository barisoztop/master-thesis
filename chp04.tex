...
Having a ready email client to implement the first version of the personalized mass email communication system helped us to save time, and get the first impression, and feedbacks from others who actively do mass email communication quickly. From the technology point of view, we were also limited with the existing EmailValet's development architecture, which was developed in \ac{RoR}
